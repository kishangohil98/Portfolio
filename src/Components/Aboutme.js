          ...
          <Row lg={2} md={2} sm={1}>
            <Col lg={6} md={6} sm={12} style={{ padding: "0px 30px" }}>
              <div className="about_me wow animate__animated animate__fadeInLeft">
                ...
                <p>
                  I am a Graduated Computer Engineer from Gujarat Technological University and having comprehension of <span style={{ color: themes.highlightText }}>NodeJS</span>,{" "}<span style={{ color: themes.highlightText }}>ReactJS</span>{" "}and its core principles.
                </p>
                <p>
                  I possess sound technical orientation over{" "}
                  <span style={{ color: themes.highlightText }}>Javascript development</span>,{" "}
                  <span style={{ color: themes.highlightText }}>NodeJS API developement</span>,{" "}
                  <span style={{ color: themes.highlightText }}>ReactJS</span>,{" "}and conventional{" "}
                  <span style={{ color: themes.highlightText }}>web technologies.</span>
                </p>
                <p>
              ...
              <div className="about_skills wow animate__animated animate__fadeInRight">
                ...
                <div className="skills">
                  <Row className="justify-content-center">
                    <p className="skill" style={{ backgroundColor: themes.highlightText }}>
