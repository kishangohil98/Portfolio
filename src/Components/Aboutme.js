          ...
          <Row lg={2} md={2} sm={1}>
            <Col lg={6} md={6} sm={12} style={{ padding: "0px 30px" }}>
              <div className="about_me wow animate__animated animate__fadeInLeft">
                ...
                <p>
                  I am a Full Stack Javascript developer in Vadodara, India.
                </p>
                <p>
                  Organized and self-motivated software engineer with 4 years of
                  hands-on experience across all SDLC phases, including
                  requirement gathering, analysis, design, development, testing,
                  and support.
                </p>
                <p>
                ...
                <p>
                  Graduated Computer Engineer from Gujarat Technological
                  University and having comprehension of{" "}
                ...
                <div className="skills">
                  <Row className="justify-content-center">
                    ...
                    <p
                      ...
                      style={{ backgroundColor: themes.highlightText }}
                    >
                      <FontAwesomeIcon icon={faCss3} className="skill_icon" />
                      Tailwind CSS
                    </p>
                    <p
                      className="skill"
